...
namespace Acquaint.XForms
{
	public partial class AcquaintanceListPage : ContentPage
	{
		...
		void ItemTapped(object sender, ItemTappedEventArgs e)
		{
		    ...
		    AcquaintanceDetailPage acquaintanceDetailPage = new AcquaintanceDetailPage(new AcquaintanceDetailViewModel((Acquaintance)e.Item));
		    Navigation.PushAsync(acquaintanceDetailPage.ContentPage);
